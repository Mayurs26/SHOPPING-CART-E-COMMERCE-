        ...
        <div class="logreg-box">
            <div class="form-box login">
                <form action="saveadmin" method="post">
                    ...
                    <a href="ApproveMerchant.jsp" class="link">Approve Merchant</a><br><br>
				    <a href="ViweMerchant.jsp"  class="link">View Merchant</a><br><br>
				    <a href="DeleteMerchant.jsp"  class="link">Delete Merchant</a><br><br>
				    <a href="BlockMerchant.jsp"  class="link">Block Merchant</a><br><br>
				    <a href="BlockAndDeleteCustomer.jsp"  class="link">Block & Delete Customer</a><br><br>
			    	<a href="ViewAllCustomer.jsp"  class="link">View All Customer</a><br><br>
